...
game.onUpdateInterval(5000, function () {
    sprites.destroyAllSpritesOfKind(SpriteKind.Pistol)
    sprites.destroyAllSpritesOfKind(SpriteKind.ShotGun)
    sprites.destroyAllSpritesOfKind(SpriteKind.rocket)
    sprites.destroyAllSpritesOfKind(SpriteKind.RATATATATA)
    sprites.destroyAllSpritesOfKind(SpriteKind.raygun)
    gunsmanage()
})
